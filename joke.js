...
var joke = "https://official-joke-api.appspot.com/random_joke";
var jokesText = document.querySelector("#jokes");
var loader = document.querySelector("img");
var jokeButton = document.querySelector(".newJokes");
function getSWData() {
    return __awaiter(this, void 0, void 0, function () {
        var response, jokes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(joke)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    jokes = _a.sent();
                    return [2 /*return*/, jokes];
            }
        });
    });
}
